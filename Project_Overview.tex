...
%     \end{figure}
%     \mbox{}\\[2.0cm]
%     \textsc{\Huge Microprocessor, Microcontroller and Assembly Sessional}\\[2.5cm]
%     \textsc{\Large Subject code: CSE-306}\\[2.0cm]
%     \textsc{\LARGE Project Proposal}\\[2.0cm]
%     \HRule\\[0.4cm]
%     {\large \bf {Title -- Remote Controlled Surveillance Bot with Object Detection}}\\[0.2cm]
%     \HRule\\[1.5cm]
% \end{center}
...
%             \large Major Abdullah Faisal\\
%             \large Sajedullah Aref\\
%         \end{flushleft}
%     \end{minipage}%
%     \begin{minipage}{0.5\textwidth}
%         \begin{flushright}
...
%             {\texttt{\large 202214003}}\\
%             {\texttt{\large 202214056}}
%         \end{flushright}
%     \end{minipage}
% \end{center}
% \begin{flushleft}
...
\newpage
    ...
    \begin{figure}[h]
        \centering
        \includegraphics[width=0.25\linewidth]{pan_tilt.jpg}
